...
#v(1fr)
#align(center)[#text(32pt)[Kommunikation und Syncrhonisation \  #align(center)[#image("images/art.png", width: 80%)] ] \ Stable Diffusion Art "Networks"]
#v(1fr)
...
#v(2mm)
#grid(rows: (auto,)*5, columns: (14%, 43%, 43%), gutter: 10pt,  [*Schicht*], [*Post*], [*Netzwerk*],
[*Anwendung*],[Informationsaustausch Schulleiter],[anwendungsspezifische Interpretation der übertragenen Daten, Syntaxüberprüfung, ggf. Codierung oder Kompression der Daten],
...
Das Modell ist so noch nicht ganz vollständig, die einzelnen Schichten können noch feiner ausgearbeitet werden. Insgesamt gibt es sieben Schichten:
...
#grid(columns: (25%, 75%), rows: (auto,)*8,
